...
public class Bhuser implements Serializable {
	...
	public String getGravatorurl() {
		return this.gravatorurl;
	}

	public void setGravatorurl(String gravatorurl) {
		this.gravatorurl = gravatorurl;
	}
